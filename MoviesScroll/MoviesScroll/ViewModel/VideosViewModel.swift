...
class VideosViewModel {
    ...
    func getVideos(videoId: String) {
        ...
        WebService().fetchMovieDetails(for: Int(videoId)!, url: urlVideo) { videoDetails in
            if let videoDetails = videoDetails, let results = videoDetails.videos?.results {
    ...
    func getTvVideos(videoId: String) {
        ...
        WebService().fetchTVShowsDetails(for: Int(videoId)!, url: urlVideo) { videoDetails in
            if let videoDetails = videoDetails, let results = videoDetails.videos?.results {
